 ...
 */
export function calculateOverwriteDelta(
  start: number,
  end: number,
  content: string
): PositionDelta {
 ...
 */
export function calculateAppendRightDelta(
  index: number,
  content: string
): PositionDelta {
  return {
 ...
 * Positions >= 10 are shifted right by 5
 */
export function calculatePrependLeftDelta(
  index: number,
  content: string
): PositionDelta {
  return {
 ...
 */
export function calculateRemoveDelta(
  start: number,
  end: number
): PositionDelta {
  return {
 ...
 */
export function applyDeltaToPosition(
  position: number,
  delta: PositionDelta
): number {
